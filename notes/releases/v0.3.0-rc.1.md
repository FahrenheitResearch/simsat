# SimSat v0.3.0-rc.1 — Earth colors and next-generation satellite preview

This release candidate brings the improved cloud/surface rendering work since v0.2.1 into a testable Windows Studio build. It adds unshaded seasonal Earth maps, measured MODIS land colors, and repeatable local cases with automatic PNG export.
